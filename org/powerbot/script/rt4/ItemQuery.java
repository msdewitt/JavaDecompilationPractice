...
public abstract class ItemQuery<K extends Identifiable,  extends Nameable,  extends Stackable,  extends Viewable,  extends org.powerbot.script.Actionable> extends AbstractQuery<ItemQuery<K>, K, ClientContext> implements org.powerbot.script.Identifiable.Query<ItemQuery<K>>, Nameable.Query<ItemQuery<K>>, Stackable.Query<ItemQuery<K>>, Actionable.Query<ItemQuery<K>>, org.powerbot.script.Viewable.Query<ItemQuery<K>>
{
