...
public class EventDispatcher extends org.powerbot.bot.EventDispatcher
{
  ...
  protected int jdMethod_this(EventObject a)
  {
    ...
    throw new IllegalArgumentException(z.aux.jdMethod_this("eKc\nb\\bDs"));
  }
  ...
  protected void jdMethod_this(EventObject a, int a)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 94	org/powerbot/bot/rt4/EventDispatcher:iterator	()Ljava/util/Iterator;
    //   4: astore_3
    //   5: aload_3
    ...
    //   23: astore 4
    //   25: aload_0
    //   26: getfield 108	org/powerbot/bot/rt4/EventDispatcher:byte	Ljava/util/Map;
    //   29: aload 4
